/* =========================================================================
   ...
   - Derives full device/browser context for all events
   - Links lead → last pageview via sessionStorage
   - Drops first_seen_ts (keeps created_at)
   - Strips user_agent from form_data but retains top-level user_agent
   - tid_p now taken directly from query param key (not mapped alias)
   ========================================================================= */
